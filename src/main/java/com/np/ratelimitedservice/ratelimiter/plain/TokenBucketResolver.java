...
public class TokenBucketResolver {
    ...
    public TokenBucketResolver(CacheConfig cacheConfig, TimestampProvider timestampProvider) {
    ...
    private TokenBucket newBucket(UserContext userContext) {
        TokenBucketParameters tokenBucketParameters = userContext.pricingPlan().getTokenBucketParameters();
